...
( function( $ ){
  ...
  var simplewindow =  $( window );
  var body = $( 'body' );
  var simover = $('.simple-overlay');
  ...
  $.fn.simpleOverlay = function(){
    ...
    function overlaySizing(){
      ...
      var $overlay = simover,
        ...
        overlayWidth = simplewindow.width() - parseInt( $overlay.css( 'padding-right' ) ) - parseInt( $overlay.css( 'padding-left' ) ) - figurePadH,
        overlayHeight = simplewindow.height() - parseInt( $overlay.css( 'padding-top' ) ) - parseInt( $overlay.css( 'padding-bottom' ) ) - figurePadV;

      simover.each( function(){
    ...
    simplewindow.on( 'resize', function(){
      overlaySizing();
    } );
